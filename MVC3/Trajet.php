...
class Trajet{
    ...
    public static function findPassager($id){
        try{
            $sql = 'SELECT utilisateur.* FROM utilisateur INNER JOIN passager ON passager.utilisateur_login=utilisateur.login INNER JOIN trajet ON passager.trajet_id=trajet.id WHERE trajet.id=:id;';
